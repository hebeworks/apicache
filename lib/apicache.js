...
const message = debug('apicache')

var instances = []

export class ApiCache {
  constructor(a, b) {
    console.group(typeof a === 'string' ? a : 'ApiCache');
  ...
  realMiddleware(req, res, next, duration) {
  ...
  middleware(req, res, next) {
    ...
    return (passthru ? this.realMiddleware : this.realMiddleware(req, res, next, duration))
  }
}
